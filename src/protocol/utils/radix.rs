...
mod binary_util_test {
    ...
    fn binary_high_4bits_should_convert_to_8bits() {
        ...
        let binary_high_4bits = binary_handler::binary_high_4bits_to_8bits(value);
    ...
    fn binary_low_4bits_should_convert_to_8bits() {
        ...
        let binary_low_4bits = binary_handler::binary_low_4bits_to_8bits(value);
    ...
    fn binary_8bits_should_convert_to_decimal() {
        ...
        let value = binary_handler::binary_8bits_convert_to_decimal(value);
        assert_eq!(value, 10);
    }
    ...
    fn decimal_should_convert_to_binary_8bits() {
        let value: u8 = 10;
        let value = binary_handler::decimal_convert_to_binary_8bits(value);
