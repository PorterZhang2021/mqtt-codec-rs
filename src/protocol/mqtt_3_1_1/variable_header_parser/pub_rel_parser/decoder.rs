...
use crate::protocol::mqtt_3_1_1::variable_header_parser::pub_rel_parser::variable_header::PubRelVariableHeader;
use crate::protocol::mqtt_protocol_error::MqttProtocolError;
use crate::utils::mqtt_utils;

#[allow(dead_code)]
impl MqttVariableHeaderDecoder for PubRelVariableHeader {
    fn decode(
...
impl PubRelVariableHeader {
    pub(super) fn decode(
        ...
        Ok(PubRelVariableHeader::new(packet_identifier))
    }
}
